<?php 
	...
	$per_page = 10;
		...
		if($orders->num_rows) {
            ...
            <td>
                <button class='btn btn-danger' onClick=\"deleteOrder('$oid')\">Delete</button>
            </td>
          </tr>";
                        ...
                        <div class="card">
							...
							<div class="row">
								...
								<div class="col-md-12" >
									...
									<div class="col-md-3" style="text-align: center; background: #d31431; color: #fff; border-right: 1px solid #000;">
									
										<h5>ORDER ID</h5>
										
									</div>
									
									<div class="col-md-9" style="background: #d31431; color: #fff;">

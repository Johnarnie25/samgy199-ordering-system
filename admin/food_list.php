...
$query = $db->query("SELECT date_made, SUM(total) AS daily_income FROM basket GROUP BY date_made ORDER BY date_made ASC");
while ($row = $query->fetch_assoc()) {
    $dateLabels[] = $row['date_made'];
    $incomeData[] = (int)$row['daily_income'];
}

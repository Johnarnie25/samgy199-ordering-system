                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="food_add.php" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="category" class="form-control" required />
													...
													<option value="breakfast">Meet</option>
													<option value="lunch">Side Dishes</option>
													<option value="dinner">Drinks</option>
													<option value="special">Soup and Rice</option>
												</select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" name="submit" style="background: #d31431; border: 1px solid #000" value="Save Food" class="btn btn-info btn-fill pull-right" />

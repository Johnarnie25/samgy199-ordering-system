			...
			if($row['food_category'] == "breakfast") {
				...
				$bfast .= "<div class='parallax_item'>
							...
							<div class='detail'>
								...
								<p class='price'>₱".number_format($row['food_price'], 2)."</p>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Meet</span></h2>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Side Dishes</span></h2>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Drinks</span></h2>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Soup & Rice</span></h2>
